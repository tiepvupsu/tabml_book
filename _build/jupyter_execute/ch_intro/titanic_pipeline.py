...
get_ipython().run_cell_magic('capture', '', '!kaggle competitions submit -c titanic -f titanic_submission.csv -m "simple submission"')
...
get_ipython().system('rm titanic_submission.csv')
