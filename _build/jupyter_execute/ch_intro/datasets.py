...
get_ipython().system('ls ../data/titanic')
...
get_ipython().system('cat ../data/titanic/train.csv | head -5')
...
get_ipython().system('csvlook ../data/titanic/train.csv | head -6 # one additional line as header/content spliter')
